...
/**
 * Mobile-only replacement for `app/app/page.tsx`.
 *
 ...
 *
 * `scripts/build-mobile.mjs` copies this over `app/app/page.tsx` for the
 * duration of the mobile build and restores the original afterwards.
 */
