...
This project is indexed by GitNexus as **Construction_worker_log_new** (1576 symbols, 2831 relationships, 132 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
